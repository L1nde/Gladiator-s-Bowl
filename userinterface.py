...
class ui():
    def __init__(self, em):
        ...
        self.buttons.append(button(1010, 130, 190, 25, "Show lbot last 50 scores", self.drawLBotScorePlot))
    ...
    def draw(self, w):
        ...
        self.drawBotsData(w, 5, 600, 190, 195)
    ...
    def drawBotsData(self, w, x0, y0, x1, y1):
        ...
        w.blit(self.font.render("LBots info", False, (0, 0, 0)), (self.x0 + x0 + 5, self.y0 + y0 + 80))
        w.blit(self.font.render("gen: " + str(self.em.lBotsGen), False, (0, 0, 0)),
               (self.x0 + x0 + 5, self.y0 + y0 + 100))
        w.blit(self.font.render("In pool: " + str(len(self.em.lBotsPool)), False, (0, 0, 0)),
               (self.x0 + x0 + 5, self.y0 + y0 + 120))
